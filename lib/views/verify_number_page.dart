      ...
      body: Padding(
        ...
        child: Center(
          child: Column(
            children: [
              cookStack(),
              textWidget(text: "Verify phone number",textStyleWeight: TextStyleWeight.bold),
              textWidget(
              ...
              Padding(
                ...
                child: textWidget(color: colorClass.colorInstance.blueGreyColor, text: "By signing up you agree to",textStyleWeight: TextStyleWeight.thin),
              ),
