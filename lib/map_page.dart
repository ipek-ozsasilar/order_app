        ...
        child: Center(
          child: Column(
            children: [
             ...
             weightText(text: "Find Nearby Restaurants") ,
             thinText(color: colorClass.colorInstance.blueGreyColor, text: "Enter your location or allow access to your location to find restaurants near you."),
              Padding(
